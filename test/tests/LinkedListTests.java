...
class LinkedListTests {
	...
	void testFindNode() {
		...
		assertNotEquals("g", this.linkedList.retrieve(2));
	}
	...
	void testSize() {
		...
		assertEquals(4, this.linkedList.size());
		assertNotEquals(5, this.linkedList.size());
	}
	...
	void testRetrieve() {
		...
		assertNotEquals("g", this.linkedList.retrieve(3));
	...
	void testContains() {
		...
		assertFalse(this.linkedList.contains("g"));
	}
}
